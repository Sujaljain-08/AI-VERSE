      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-6 flex items-center gap-4">
          ...
          <select
            ...
            className="px-4 py-2 border border-white/10 rounded-lg bg-white/5 text-white focus:ring-2 focus:ring-[#FD366E] focus:border-[#FD366E] backdrop-blur-sm"
          >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
          <div className="bg-white/5 border border-white/10 rounded-lg shadow p-6 backdrop-blur-sm">
          ...
          <div className="bg-white/5 border border-white/10 rounded-lg shadow p-6 backdrop-blur-sm">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm text-white/60">Total Exams</p>
